...
public class GestorError {
    ...
    public static void writeError(String tipo, String errorMessage) {
        try {
            pte.write("Error " + tipo + " en la linea [" + countLine + "]: " + errorMessage + "\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
            ...
            try {
                switch (currError) {
                    ...
                    case eLex2_ERROR_LONGITUD_MAXIMA_CADENA:
                        pte.write("Error en la linea [" + countLine
                                + "]: La cadena no puede contener mÃ¡s de 64 caracteres - " + errorCase + "\n");
                        break;
                    ...
                    case eLex3_ERROR_LONGITUD_MAXIMA_ID:
                        pte.write("Error en la linea [" + countLine
                                + "]: El identificador no puede contener mÃ¡s de 32 caracteres - " + errorCase + "\n");
                        break;
                    ...
                    case eSem7_case_bloque_error:
                        pte.write("Error en la linea [" + countLine + "]: Error en el bloque de ejecuciÃ³n del case.\n");
                        break;
                    case eSem8_funcion_parametro_incompatible_error:
                        pte.write("Error en la linea [" + countLine + "]: Error en la llamada a la funciÃ³n.\n");
                        break;
                    ...
                    case eSem10_expresion_error:
                        pte.write("Error en la linea [" + countLine + "]: Error en la expresiÃ³n posterior a when.\n");
                        break;
