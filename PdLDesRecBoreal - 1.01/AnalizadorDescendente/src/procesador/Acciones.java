...
enum Acciones {
	...
	// Acciones del analizador lÃ©xico
	...
	//Error por superar la longitud mÃ¡xima de cadena (64 caracteres). 
	eLex2_ERROR_LONGITUD_MAXIMA_CADENA,
	
	//Error por alcanzar el fin de fichero sin finalzar la declaraciÃ³n de cadena. 
	eLex2_ERROR_CADENA_INCOMPLETA,
	
	//Error por superar la longitud mÃ¡xima de id (32 caracteres). 
	eLex3_ERROR_LONGITUD_MAXIMA_ID,
	
	//Error por superar el valor enterno mÃ¡ximo representable (2e15).
